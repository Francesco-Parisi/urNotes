...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/engine1/toastr/toastr.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/engine1/datatable/jquery.dataTables.min.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/engine1/dropzone/filesystem_dropzone.css">
