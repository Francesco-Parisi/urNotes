...
public class GetFormAggiungiImmagine extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(Integer.parseInt(request.getParameter("richiesta"))  == 1) {
        	...
        	contenuto += "<div action='"+request.getContextPath()+"/UploadImmagineDocumento' class='dropzoneImmagineDocumento'></div>";	        
        	contenuto += "<input type='hidden' id='filenameImmagineDocumento' value='' />";
