...
/**
 * Servlet implementation class UploadFileRichiesta
 */
@WebServlet("/UploadFileRichiesta")
public class UploadFileRichiesta extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!file.exists()) {
            if (!file.mkdir()) {
    	    	risultato = 0;
    			errore = "Errore Creazione Cartella per i file della Richiesta";
    			return;
            }
        }                
