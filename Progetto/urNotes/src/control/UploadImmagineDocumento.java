...
/**
 * Servlet implementation class UploadImmagineDocumento
 */
@WebServlet("/UploadImmagineDocumento")
public class UploadImmagineDocumento extends HttpServlet {
     ...
     */
    public UploadImmagineDocumento() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!file.exists()) {
            if (!file.mkdir()) {
    	    	risultato = 0;
    			errore = "Errore Creazione Cartella per le immagini del Documento";
    			return;
            }
        }                
