				...
				if(!result.wasNull()) {
					...
					while(result.next()) {
						contenuto += "<tr>";
							...
							contenuto += "<td>";
							contenuto += result.getString("stato");
							contenuto += "&nbsp;<i class='modificaStato modificaStatoOrdine fas fa-edit' style='cursor: pointer;' data-idordine='"+result.getInt("id_ordine")+"' title='Modifica Stato Ordine'></i>";									
							contenuto += "</td>";							
